...
function refreshChart() {
    categories = localStorage.getItem("productivity_Keys").split(",");
    times = localStorage.getItem("productivity_Values").split(",");
...
function drawChart(destroy) {
    ...
    myChart = new Chart(ctx, {
        ...
        options: {
            ...
            title: {
                display: true,
                text: "How Productive You Were On Your Computer",
